...
router.post('/',
  ...
  [
    ...
    body('rating_overall').optional().isInt({ min: 1, max: 10 }),
    body('rating_difficulty').optional().isInt({ min: 1, max: 10 }),
    body('rating_workload').optional().isInt({ min: 1, max: 10 }),
    body('rating_teaching').optional().isInt({ min: 1, max: 10 }),
